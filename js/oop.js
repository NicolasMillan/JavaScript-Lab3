...
*/
function Hamburger(buns,garnishes,cheeses,sauce,meat,pattysize,){
    this.buns = buns
    ...
    this.inf = function(){
        return `Your Burger is componed for the following ingredients: Bun: ${this.buns} Garnishes: ${this.garnishes} Cheeses: ${this.cheeses} Sauce: ${this.sauce} Meat: ${this.meat} pattysize: ${this.pattysize}.`
    }
}

var SuperHamburger = new Hamburger("Multigrain ", ["Pickle","Lettuce","Tomato"], "Cheddar", "Garlic", "beaf", "triple");

// add some extra if you want
// Make sure that the function allows for the output of a sentence that describes the hamburger, too
console.log(SuperHamburger.inf());
